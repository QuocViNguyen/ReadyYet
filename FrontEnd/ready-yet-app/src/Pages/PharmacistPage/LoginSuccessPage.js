...
class LoginSuccessPage extends Component {
    ...
    render() { 
        return (
            ...
            //         <Box className='text-3xl pb-10 font-semibold'>WELCOME {this.props.name}</Box>
            //         <form>
            //             <Box className="flex flex-col space-y-6 ">
            //                 <TextField id="outlined-basic" label="Username" variant="outlined" value={this.state.email}/>
            //                 <TextField id="outlined-basic" label="Password" variant="outlined" type='password' value={this.state.password}/>
